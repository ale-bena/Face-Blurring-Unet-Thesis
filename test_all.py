...
def save_image(tensor, path, output_details=None, format_type='png', quality=95):
    """Save tensor as image with specified format"""
...
def detect_model_type(model_path):
    """Detect if model is Keras or TFLite based on file extension"""
...
def main(args):
    """Main function to run inference with any model type"""
